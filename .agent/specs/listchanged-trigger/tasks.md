...
- [x] T001 [US2] Wire InjectInitializeCapability into cacheResponse in internal/muxcore/owner/owner.go
...
- [x] T002 [US1] Implement broadcastListChanged helper in internal/muxcore/owner/owner.go
...
- [x] T003 [US1] Call broadcastListChanged on upstream restart in owner.go
...
- [x] G001 VERIFY Phase 1 (T001–T003) — injection wired, broadcast on restart, 18 packages green
...
- [x] T004 [P] Write listChanged wiring tests in internal/muxcore/owner/listchanged_inject_test.go
...
- [x] T005 Full regression + deploy — 18 packages green, vet clean
  AC: go test ./... -count 1 passes · go vet clean · go build clean · mcp-mux binary deployed

- [x] T006 Update roadmap, CONTINUITY, version
  AC: roadmap Sprint 2 marked done · CONTINUITY updated · version tagged

- [x] G002 VERIFY Phase 2 (T004–T006) — all done, roadmap updated
